...
export const metadata = {
  ...
  description: '로또 번호 생성기 사이트의 개인정보처리방침입니다. 수집 정보와 쿠키 사용 방식을 확인하세요.',
    ...
    <main className={styles.main}>
      <div className={styles.container}>
        ...
        <section className={styles.content}>
          ...
          <p>
            로또 번호 생성기(이하 "사이트")는 이용자의 개인정보를 소중히 여기며, 관련 법령을 준수합니다.
            본 방침은 사이트가 수집하는 정보의 종류, 이용 목적, 제3자 제공 여부 등을 설명합니다.
          </p>

          <h2 className={styles.h2}>2. 수집하는 정보</h2>
          <p>
            본 사이트는 별도의 회원가입 없이 로또 번호 생성 기능을 제공합니다. 이용자가 생성한 번호, 저장 기록,
            당첨 확인 입력값은 서버에 저장되지 않으며 브라우저 내에서만 처리됩니다.
          </p>
          ...
          <p>
            본 사이트는 Google LLC에 광고 서비스(Google AdSense)를 위탁합니다. Google은 쿠키를 사용하여
            이용자의 관심사 기반 광고를 제공할 수 있습니다. Google의 개인정보처리방침은
            <a
          ...
          <p>
            쿠키는 웹사이트가 브라우저에 저장하는 소량의 데이터 파일입니다. 본 사이트는 광고 효율 측정 및 방문자 분석을 위해
            쿠키를 사용합니다. 브라우저 설정에서 쿠키 수신을 거부할 수 있으나, 일부 기능이 제한될 수 있습니다.
          </p>
          <p style={{ marginTop: '10px' }}>
          ...
          <p>
            자동 수집 정보(로그, 쿠키 등)는 수집 목적이 달성되거나 이용자가 삭제를 요청할 때까지 보유됩니다.
            Google Analytics의 데이터 보유 기간은 Google 정책을 따릅니다.
          </p>

          <h2 className={styles.h2}>7. 이용자 권리</h2>
          <p>
            이용자는 언제든지 쿠키 삭제(브라우저 설정), 광고 개인화 거부(Google 광고 설정) 등을 통해 개인정보 처리에 대한
            동의를 철회할 수 있습니다.
          </p>
